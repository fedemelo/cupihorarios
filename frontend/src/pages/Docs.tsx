          ...
          <Stack spacing={1}>
            ...
            <Typography variant="body1" sx={{ textAlign: 'justify' }}>
              ...
              <ul>
                ...
                <li><strong>Horas de Trabajo Proporcionales:</strong> Los horarios se generan con base en las horas contractuales de cada asistentes. Se busca una distribución proporcional del trabajo. En particular, CupiHorarios intenta dos cosas:</li>
                <ul>
                  <li>Que cada asistente trabaje más o menos la misma cantidad de horas de forma presencial y remota.</li>
                  <li>Que cada asistente trabaje las horas que proporcionalmente le corresponden por contrato. E.g: si se tienen 6 asistentes de pregrado y 2 de posgrado, y CupiTaller está abierto 50 horas a la semana, entonces los asistentes de pregrado deberían trabajar cada uno, más o menos, 5 horas presenciales y las mismas remotas, y los de posgrado, más o menos, 10 horas.</li>
                </ul>
