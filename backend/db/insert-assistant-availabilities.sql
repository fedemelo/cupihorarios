...
INSERT INTO assistant_availabilities (id, assistant_code, time_slot_id, virtual_only) 
VALUES (uuid_generate_v4(), 201820147, (SELECT id FROM time_slots WHERE day = 'TUESDAY' AND start_hour = 930), false);

INSERT INTO assistant_availabilities (id, assistant_code, time_slot_id, virtual_only) 
VALUES (uuid_generate_v4(), 201820147, (SELECT id FROM time_slots WHERE day = 'WEDNESDAY' AND start_hour = 930), false);

INSERT INTO assistant_availabilities (id, assistant_code, time_slot_id, virtual_only) 
VALUES (uuid_generate_v4(), 201820147, (SELECT id FROM time_slots WHERE day = 'THURSDAY' AND start_hour = 930), false);

INSERT INTO assistant_availabilities (id, assistant_code, time_slot_id, virtual_only) 
VALUES (uuid_generate_v4(), 201820147, (SELECT id FROM time_slots WHERE day = 'TUESDAY' AND start_hour = 1030), false);

INSERT INTO assistant_availabilities (id, assistant_code, time_slot_id, virtual_only) 
VALUES (uuid_generate_v4(), 201820147, (SELECT id FROM time_slots WHERE day = 'WEDNESDAY' AND start_hour = 1030), false);

INSERT INTO assistant_availabilities (id, assistant_code, time_slot_id, virtual_only) 
VALUES (uuid_generate_v4(), 201820147, (SELECT id FROM time_slots WHERE day = 'THURSDAY' AND start_hour = 1030), false);

INSERT INTO assistant_availabilities (id, assistant_code, time_slot_id, virtual_only) 
VALUES (uuid_generate_v4(), 201820147, (SELECT id FROM time_slots WHERE day = 'TUESDAY' AND start_hour = 1100), false);

INSERT INTO assistant_availabilities (id, assistant_code, time_slot_id, virtual_only) 
VALUES (uuid_generate_v4(), 201820147, (SELECT id FROM time_slots WHERE day = 'WEDNESDAY' AND start_hour = 1100), false);

INSERT INTO assistant_availabilities (id, assistant_code, time_slot_id, virtual_only) 
VALUES (uuid_generate_v4(), 201820147, (SELECT id FROM time_slots WHERE day = 'THURSDAY' AND start_hour = 1100), false);

INSERT INTO assistant_availabilities (id, assistant_code, time_slot_id, virtual_only) 
VALUES (uuid_generate_v4(), 201820147, (SELECT id FROM time_slots WHERE day = 'FRIDAY' AND start_hour = 1100), false);

INSERT INTO assistant_availabilities (id, assistant_code, time_slot_id, virtual_only) 
VALUES (uuid_generate_v4(), 201820147, (SELECT id FROM time_slots WHERE day = 'TUESDAY' AND start_hour = 1200), false);

INSERT INTO assistant_availabilities (id, assistant_code, time_slot_id, virtual_only) 
VALUES (uuid_generate_v4(), 201820147, (SELECT id FROM time_slots WHERE day = 'WEDNESDAY' AND start_hour = 1200), false);

INSERT INTO assistant_availabilities (id, assistant_code, time_slot_id, virtual_only) 
VALUES (uuid_generate_v4(), 201820147, (SELECT id FROM time_slots WHERE day = 'THURSDAY' AND start_hour = 1200), false);

INSERT INTO assistant_availabilities (id, assistant_code, time_slot_id, virtual_only) 
VALUES (uuid_generate_v4(), 201820147, (SELECT id FROM time_slots WHERE day = 'FRIDAY' AND start_hour = 1200), false);

INSERT INTO assistant_availabilities (id, assistant_code, time_slot_id, virtual_only) 
VALUES (uuid_generate_v4(), 201820147, (SELECT id FROM time_slots WHERE day = 'MONDAY' AND start_hour = 1230), false);

INSERT INTO assistant_availabilities (id, assistant_code, time_slot_id, virtual_only) 
VALUES (uuid_generate_v4(), 201820147, (SELECT id FROM time_slots WHERE day = 'TUESDAY' AND start_hour = 1230), false);

INSERT INTO assistant_availabilities (id, assistant_code, time_slot_id, virtual_only) 
VALUES (uuid_generate_v4(), 201820147, (SELECT id FROM time_slots WHERE day = 'WEDNESDAY' AND start_hour = 1230), false);

INSERT INTO assistant_availabilities (id, assistant_code, time_slot_id, virtual_only) 
VALUES (uuid_generate_v4(), 201820147, (SELECT id FROM time_slots WHERE day = 'THURSDAY' AND start_hour = 1230), false);

INSERT INTO assistant_availabilities (id, assistant_code, time_slot_id, virtual_only) 
VALUES (uuid_generate_v4(), 201820147, (SELECT id FROM time_slots WHERE day = 'FRIDAY' AND start_hour = 1230), false);

INSERT INTO assistant_availabilities (id, assistant_code, time_slot_id, virtual_only) 
VALUES (uuid_generate_v4(), 201820147, (SELECT id FROM time_slots WHERE day = 'MONDAY' AND start_hour = 1330), false);

INSERT INTO assistant_availabilities (id, assistant_code, time_slot_id, virtual_only) 
VALUES (uuid_generate_v4(), 201820147, (SELECT id FROM time_slots WHERE day = 'WEDNESDAY' AND start_hour = 1330), false);

INSERT INTO assistant_availabilities (id, assistant_code, time_slot_id, virtual_only) 
VALUES (uuid_generate_v4(), 201820147, (SELECT id FROM time_slots WHERE day = 'THURSDAY' AND start_hour = 1330), false);

INSERT INTO assistant_availabilities (id, assistant_code, time_slot_id, virtual_only) 
VALUES (uuid_generate_v4(), 201820147, (SELECT id FROM time_slots WHERE day = 'FRIDAY' AND start_hour = 1330), false);

INSERT INTO assistant_availabilities (id, assistant_code, time_slot_id, virtual_only) 
VALUES (uuid_generate_v4(), 201820147, (SELECT id FROM time_slots WHERE day = 'MONDAY' AND start_hour = 1400), false);

INSERT INTO assistant_availabilities (id, assistant_code, time_slot_id, virtual_only) 
VALUES (uuid_generate_v4(), 201820147, (SELECT id FROM time_slots WHERE day = 'WEDNESDAY' AND start_hour = 1400), false);

INSERT INTO assistant_availabilities (id, assistant_code, time_slot_id, virtual_only) 
VALUES (uuid_generate_v4(), 201820147, (SELECT id FROM time_slots WHERE day = 'THURSDAY' AND start_hour = 1400), false);

INSERT INTO assistant_availabilities (id, assistant_code, time_slot_id, virtual_only) 
VALUES (uuid_generate_v4(), 201820147, (SELECT id FROM time_slots WHERE day = 'FRIDAY' AND start_hour = 1400), false);

INSERT INTO assistant_availabilities (id, assistant_code, time_slot_id, virtual_only) 
VALUES (uuid_generate_v4(), 201820147, (SELECT id FROM time_slots WHERE day = 'MONDAY' AND start_hour = 1500), false);

INSERT INTO assistant_availabilities (id, assistant_code, time_slot_id, virtual_only) 
VALUES (uuid_generate_v4(), 201820147, (SELECT id FROM time_slots WHERE day = 'WEDNESDAY' AND start_hour = 1500), false);

INSERT INTO assistant_availabilities (id, assistant_code, time_slot_id, virtual_only) 
VALUES (uuid_generate_v4(), 201820147, (SELECT id FROM time_slots WHERE day = 'THURSDAY' AND start_hour = 1500), false);

INSERT INTO assistant_availabilities (id, assistant_code, time_slot_id, virtual_only) 
VALUES (uuid_generate_v4(), 201820147, (SELECT id FROM time_slots WHERE day = 'FRIDAY' AND start_hour = 1500), false);

INSERT INTO assistant_availabilities (id, assistant_code, time_slot_id, virtual_only) 
VALUES (uuid_generate_v4(), 201820147, (SELECT id FROM time_slots WHERE day = 'MONDAY' AND start_hour = 1530), false);

INSERT INTO assistant_availabilities (id, assistant_code, time_slot_id, virtual_only) 
VALUES (uuid_generate_v4(), 201820147, (SELECT id FROM time_slots WHERE day = 'THURSDAY' AND start_hour = 1530), false);

INSERT INTO assistant_availabilities (id, assistant_code, time_slot_id, virtual_only) 
VALUES (uuid_generate_v4(), 201820147, (SELECT id FROM time_slots WHERE day = 'FRIDAY' AND start_hour = 1530), false);

INSERT INTO assistant_availabilities (id, assistant_code, time_slot_id, virtual_only) 
VALUES (uuid_generate_v4(), 201820147, (SELECT id FROM time_slots WHERE day = 'MONDAY' AND start_hour = 1630), false);

INSERT INTO assistant_availabilities (id, assistant_code, time_slot_id, virtual_only) 
VALUES (uuid_generate_v4(), 201820147, (SELECT id FROM time_slots WHERE day = 'TUESDAY' AND start_hour = 1630), false);

INSERT INTO assistant_availabilities (id, assistant_code, time_slot_id, virtual_only) 
VALUES (uuid_generate_v4(), 201820147, (SELECT id FROM time_slots WHERE day = 'THURSDAY' AND start_hour = 1630), false);

INSERT INTO assistant_availabilities (id, assistant_code, time_slot_id, virtual_only) 
VALUES (uuid_generate_v4(), 201820147, (SELECT id FROM time_slots WHERE day = 'FRIDAY' AND start_hour = 1630), false);

INSERT INTO assistant_availabilities (id, assistant_code, time_slot_id, virtual_only) 
VALUES (uuid_generate_v4(), 201820147, (SELECT id FROM time_slots WHERE day = 'MONDAY' AND start_hour = 1700), false);

INSERT INTO assistant_availabilities (id, assistant_code, time_slot_id, virtual_only) 
VALUES (uuid_generate_v4(), 201820147, (SELECT id FROM time_slots WHERE day = 'TUESDAY' AND start_hour = 1700), false);

INSERT INTO assistant_availabilities (id, assistant_code, time_slot_id, virtual_only) 
VALUES (uuid_generate_v4(), 201820147, (SELECT id FROM time_slots WHERE day = 'THURSDAY' AND start_hour = 1700), false);

INSERT INTO assistant_availabilities (id, assistant_code, time_slot_id, virtual_only) 
VALUES (uuid_generate_v4(), 201820147, (SELECT id FROM time_slots WHERE day = 'FRIDAY' AND start_hour = 1700), false);
